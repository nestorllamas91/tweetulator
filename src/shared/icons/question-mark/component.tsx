import type { QuestionMarkIconProps } from "@/shared/icons/question-mark/types";

const QuestionMarkIcon = ({ className }: QuestionMarkIconProps): JSX.Element => (
  <svg viewBox="0 0 92 92" className={className}>
